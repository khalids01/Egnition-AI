defmodule EgnitionWeb.Router do
  ...
  scope "/", EgnitionWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{EgnitionWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", EgnitionWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{EgnitionWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", EgnitionWeb do
    ...
    live_session :current_user,
      on_mount: [{EgnitionWeb.UserAuth, :mount_current_user}] do
